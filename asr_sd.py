...
import wget
from load_config import cfg, data_dir
...
cfg.diarizer.asr.parameters.threshold = (
    50  # ASR based VAD threshold: If 100, all silences under 1 sec are ignored.
)
cfg.diarizer.asr.parameters.decoder_delay_in_sec = (
    None  # Decoder delay is compensated for 0.2 sec
)
...
predicted_speaker_label_rttm_path = str(
    data_dir / "pred_rttms/mondialisation_full.rttm"
)
